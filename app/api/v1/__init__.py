...
from app.api.v1.views.users_view import UserOrders, UserDeliveredOrders, UserOrdersInTransit
...
api.add_resource(UserOrdersInTransit, '/users/<int:userId>/in-transit')
